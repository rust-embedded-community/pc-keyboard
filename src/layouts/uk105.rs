...
impl KeyboardLayout for Uk105Key {
    ...
    fn map_keycode(
        ...
        match keycode {
            ...
            KeyCode::Oem5 => modifiers.handle_shift(SLS, '|'),
            KeyCode::Oem7 => modifiers.handle_shift('#', '~'),
            KeyCode::Oem8 => modifiers.handle_altsh('`', '¬', '¦'),
            KeyCode::E    => modifiers.handle_alalt('E', 'é', 'É', handle_ctrl),
            KeyCode::U    => modifiers.handle_alalt('U', 'ú', 'Ú', handle_ctrl),
            KeyCode::I    => modifiers.handle_alalt('I', 'í', 'Í', handle_ctrl),
            KeyCode::O    => modifiers.handle_alalt('O', 'ó', 'Ó', handle_ctrl),
